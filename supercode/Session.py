...
NORMAL_CUSTOMER_FREQUENCY = 20 # average seconds between customers when all prices are $100 (calculations for heroes and villains are done individually so this is actually twice as frequent if you consider both halves of the shop)
